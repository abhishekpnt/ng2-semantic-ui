...
export declare abstract class SuiSelectBase<T, U> implements AfterContentInit, OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<SuiSelectBase<any, any>, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<SuiSelectBase<any, any>, never, never, { "isSearchable": "isSearchable"; "icon": "icon"; "transition": "transition"; "transitionDuration": "transitionDuration"; "isDisabled": "isDisabled"; "options": "options"; "optionsFilter": "optionsFilter"; "optionsLookup": "optionsLookup"; "labelField": "labelField"; "optionFormatter": "optionFormatter"; "_tabIndex": "tabindex"; "valueField": "valueField"; "optionTemplate": "optionTemplate"; }, { "onTouched": "touched"; }, ["_manualSearch", "_renderedOptions"]>;
}
